  ...
  return (
    <div className="flex flex-col gap-8 h-full" onClick={() => setActiveDropdown(null)}>
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-100 bg-white">
              {alquileresFiltrados.map((alq) => (
                <tr key={alq.id} className="hover:bg-slate-50 transition-colors group cursor-pointer relative">
                  <td className="py-3 px-4 text-sm text-slate-900 font-medium">#{alq.id || alq.consecutivo}</td>
                  ...
                  <td className="py-3 px-4 text-sm font-bold text-slate-700">{formatearMoneda(alq.totalEstimado || 0)}</td>
                  ...
                  <td className="py-3 px-4 text-right relative">
                    <button 
                      ...
                      className="text-slate-400 hover:text-brand-salmon transition-colors p-1 rounded hover:bg-slate-100"
                    >
                    ...
                    {activeDropdown === alq.id && (
                      <div className="absolute right-8 top-10 w-48 bg-white rounded-lg shadow-xl border border-slate-100 z-50 py-1 flex flex-col text-left">
      ...
      <Modal 
        ...
        title={contratoActivo ? "Editar Contrato" : "Registrar Nuevo Contrato"}
      >
        <AlquilerForm 
