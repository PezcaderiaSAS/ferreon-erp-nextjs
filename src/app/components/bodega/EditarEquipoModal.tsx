...
type EditEquipoFormValues = z.infer<typeof editEquipoSchema>;
...
export function EditarEquipoModal({ isOpen, onClose, equipo }: EditarEquipoModalProps) {
  ...
  const { register, handleSubmit, reset, formState: { errors, isSubmitting } } = useForm<EditEquipoFormValues>({
  ...
  const onSubmitGeneral = (data: EditEquipoFormValues) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6">
        ...
        <form onSubmit={handleSubmit(onSubmitGeneral)} className="flex flex-col gap-4">
