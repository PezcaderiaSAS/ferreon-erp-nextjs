...
import { EquipoUI, useBodegaStore } from '@/infrastructure/state/bodegaStore';
import { generateIdempotencyKey } from '@/lib/utils/idempotency';
import { editarEquipoAction, ajustarStockEquipoAction } from '@/app/actions/equipos';
...
export interface EditarEquipoModalProps {
  isOpen: boolean;
  onClose: () => void;
