...
export function CrearProveedorModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!nombre.trim()) {
      setErrorMsg('La razÃ³n social o nombre del proveedor es obligatorio.');
      return;
    }
    if (!nit.trim()) {
    ...
    try {
      ...
      setErrorMsg('Error de comunicaciÃ³n con el servidor.');
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            <label className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1.5">
              RazÃ³n Social / Proveedor <span className="text-red-500">*</span>
            </label>
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1.5">
              NIT / IdentificaciÃ³n <span className="text-red-500">*</span>
            </label>
            <div className="relative">
          ...
          <div>
            ...
            <input
              ...
              placeholder="BogotÃ¡, MedellÃ­n, etc."
              className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all shadow-xs"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all shadow-xs"
              >
                <option value={0}>0 dÃ­as (Contado inmediato)</option>
                <option value={15}>15 dÃ­as</option>
                <option value={30}>30 dÃ­as (Mes comercial)</option>
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              placeholder="LÃ­nea de productos, condiciones de despacho o descuentos comerciales..."
