...
import { crearCompraAction, ItemCompraInput } from '@/app/actions/compras';
import { obtenerProveedoresAction, ProveedorUI } from '@/app/actions/proveedores';
import { useCurrencyFormatter } from '@/lib/hooks/useCurrencyFormatter';
import { SelectorProveedorAsistido } from '@/components/proveedores/SelectorProveedorAsistido';
...
export function RegistrarCompraModal({
  ...
  // Si se selecciona un proveedor con dÃ­as de crÃ©dito > 0, sugerir mÃ©todo CRÃ‰DITO
  ...
  // CÃ¡lculos reactivos con el motor tributario
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.success && res.data) {
        ...
        setErrorMsg(res.error || 'OcurriÃ³ un error al registrar la compra.');
        showErrorToast(res.error || 'Fallo al procesar compra');
      }
    } catch (err: any) {
      console.error('Error al registrar compra:', err);
      setErrorMsg('Error de red o procesamiento en el servidor.');
      showErrorToast('Error de comunicaciÃ³n con el servidor');
    } finally {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Registrar Compra / Entrada de AlmacÃ©n" maxWidth="4xl">
      <form onSubmit={handleSubmit} className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="CREDITO">CrÃ©dito (Cuentas por Pagar Proveedor)</option>
              </select>
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="GarantÃ­a, entrega, nÃºmero de guÃ­a..."
              className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all shadow-xs"
            />
          </div>
        </div>

        {/* 2. Tabla DinÃ¡mica de Ãtems / Equipos */}
        ...
        {/* 3. Panel Tributario & Resumen de LiquidaciÃ³n */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50/70 border border-slate-200/80 p-5 rounded-2xl">
            ...
            <label className="flex items-center justify-between p-2.5 bg-white border border-slate-200 rounded-xl cursor-pointer hover:border-emerald-300 transition-colors shadow-2xs">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-2xs text-slate-400">Genera crÃ©dito fiscal y dÃ©bito en Cuenta 2408</p>
                </div>
              </div>
            ...
            <div className="p-2.5 bg-white border border-slate-200 rounded-xl shadow-2xs space-y-2">
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2.5 cursor-pointer">
                  ...
                  />
                  <div>
                    <span className="text-sm font-medium text-slate-800">RetenciÃ³n en la Fuente</span>
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2.5 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-2xs text-slate-400">RetenciÃ³n de industria y comercio (Cuenta 2368)</p>
                  </div>
                </label>
                <span className="text-sm font-mono font-semibold text-rose-600">
          ...
          {/* Resumen de LiquidaciÃ³n & Partida Doble */}
          <div className="bg-white border border-slate-200 rounded-xl p-4.5 flex flex-col justify-between shadow-xs">
            <div>
              <h5 className="text-xs font-bold text-slate-700 uppercase tracking-wider mb-3 flex items-center gap-1.5">
                ...
                Resumen de LiquidaciÃ³n Contable
              </h5>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between text-rose-600 text-xs">
                  <span>(-) ReteICA ({aplicaReteica ? `${porcentajeReteica}â€°` : '0â€°'}):</span>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-slate-100">
          <div className="text-xs text-slate-500 flex items-center gap-1.5">
            ...
            Al registrar la compra, el stock fÃ­sico se incrementarÃ¡ automÃ¡ticamente y se emitirÃ¡ el asiento en el Ledger.
          </div>
