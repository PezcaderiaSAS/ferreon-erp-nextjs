...
import { 
  Building2, DollarSign, Printer, CheckCircle2, 
  RotateCcw, Truck, User, Phone
} from 'lucide-react';
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 p-4 bg-slate-50 dark:bg-slate-900/60 rounded-2xl border border-slate-200 dark:border-slate-800">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="flex items-center gap-1.5 text-xs bg-white dark:bg-slate-800 shadow-sm cursor-pointer"
            >
            ...
            {subcontratacion.estado === 'ACTIVA' && onRegistrarDevolucion && (
              <Button
                ...
                className="flex items-center gap-1.5 text-xs bg-emerald-600 hover:bg-emerald-700 text-white shadow-sm cursor-pointer"
              >
...
export default DetalleSubcontratacionModal;
